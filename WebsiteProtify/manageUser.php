                    ...
                    <div data-flex class="hide-scroll">
                        <nav class="scroll nav-stacked nav-active-primary">
                            ...
                            <ul class="nav" data-ui-nav>
                                ...
                                <li>
                                    <a href="profileAdmin.php#playlists">
                                        <span class="nav-icon">
                                            <i class="material-icons">
                                                queue_music
                                            </i>
                                ...
                                <div class="padding p-y-0 m-b-md">
                                    <div class="tab-content">
                                        ...
                                        foreach ($user as $member) {
                                            echo ' <div class = "row">
                                        <div class = "col-md-2"><div class = "box p-a">' . $member[0] . '</div></div>';
                                            if ($member[3] == 0) {
                                                echo " <div class = 'col-md-2'><div class = 'box p-a'>Admin</div></div>";
                                            } else if ($member[3] == 1) {
                                                echo " <div class = 'col-md-2'><div class = 'box p-a'>Member</div></div>";
                                            }
                                            echo ' <div class = "col-md-2"><div class = "box p-a">' . $member[4] . '</div></div>
                                                        <div class = "col-md-3"><div class = "box p-a">' . $member[2] . '</div></div>';
                                            ?>
                   


                                            <div class = "col-md-3"><div class = "box p-a"><button class="btn btn-sm rounded primary" data-toggle="modal" data-target="#<?php echo"delete" . $member[0] ?>" data-ui-toggle-class="rotate" data-ui-target="#animate">Delete</button>
                                                    <button class="btn btn-sm rounded primary" data-toggle="modal" data-target="#<?php echo 'add' . $member[0]; ?>" data-ui-toggle-class="rotate" data-ui-target="#animate">New Admin</button></div></div>
 </div>
                                        
                                        <div id = "<?php echo'delete' . $member[0] ?>" class = "modal fade animate" data-backdrop = "false">
                                            <div class = "modal-dialog" id = "animate">
                                                <div class = "modal-content">
                                                    ...
                                                    <div class = "modal-footer">
                                                        ...
                                                        <button type = 'button' class = 'btn danger p-x-md' data-dismiss = 'modal' onclick="window.location.href = 'deleteMember.php?id=<?php echo $member[0] ?>'">YES</button>
                                                    </div>
                                                </div><!--/.modal-content -->
                                            </div>
                                        </div>
                                  
                                        <div id = '<?php echo 'add' . $member[0]; ?>' class = 'modal fade animate' data-backdrop = 'false' >
                                            <div class = 'modal-dialog' id = 'animate'>
                                                <div class = 'modal-content'>
                                                    <div class = 'modal-body text-center p-lg'>
                                                        <p>Are you sure add new admin?</p>
                                                    </div>
                                                    <div class = 'modal-footer'>
                                                        <button type = 'button' class = 'btn dark-white p-x-md' data-dismiss = 'modal'>No</button>
                                                        <button type = 'button' class = 'btn danger p-x-md' data-dismiss = 'modal' onclick="window.location.href = 'updateAdmin.php?id=<?php echo $member[0] ?>'">YES</button>
...
<!--jQuery -->
<script src="scripts/AdminManage.js"></script>
