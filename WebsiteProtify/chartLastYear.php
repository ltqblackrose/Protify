                                ...
                                <div class="padding">
                                    ...
                                    <div class="page-title m-b">
                                        ...
                                        <div class="dropdown inline">
                                            <button class="btn btn-sm no-bg h4 m-y-0 v-b dropdown-toggle text-primary" data-toggle="dropdown">Last year</button>
                                    ...
                                    <?php
                                    $sql =  "SELECT TrackName, sum(TotalListen), trackfile, ImageFile, TrackID, ArtistName, ArtistID, TotalLiked, ArtistID, AlbumID FROM `vw_track_listen_date_info` WHERE year(Date) = year(CURRENT_DATE) - 1 group by TrackID ORDER BY TotalListen DESC, TrackName ASC LIMIT 10";
