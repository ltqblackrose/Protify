                    ...
                    <div class="page-content">
                        ...
                        <div class="padding p-b-0">
                            ...
                            <div class="row row-sm item-masonry item-info-overlay">
                                <div class="col-sm-6 text-white m-b-sm">
                                    <div class="owl-carousel owl-theme owl-dots-sm owl-dots-bottom-left " data-ui-jp="owlCarousel" data-ui-options="{
                                         ...
                                         ,animateOut:&#x27;fadeOut&#x27;
                                             ...
                                             <?php
                                             $sql_discover = "SELECT DISTINCT TrackID, TrackName, Length, TrackFile, ImageFile, ArtistID, ArtistName, AlbumID FROM vw_track_info ORDER BY RAND() LIMIT 3";
                                             $r_discover = mysqli_query($link, $sql_discover);
                                             $a_discover = mysqli_fetch_all($r_discover);
                                             foreach ($a_discover as $key_discover => $discover) {
                                                 $number_discover = $key_discover + 1;
                                                 ?>
                                            <div class="item r" data-id="item-<?php echo $number_discover + 7 ?>" data-src="<?php echo $discover[3] ?>">
                                                <div class="item-media primary">
                                                    <a href="album.php?albumid=<?php echo $discover[7] ?>" class="item-media-content" style="background-image: url('<?php echo $discover[4] ?>');"></a>
                                                ...
                                                <div class="item-info">
                                                    <div class="item-overlay bottom text-right">
                                                        ...
                                                        <!-- Like Button-->
                                                        <form action="Like_Track_savedata.php" id='like_track_<?php echo $discover[0] ?>' >
                                                            <input style = "display:none" type="text" name="txtaction" <?php if (userLiked($discover[0])): ?> value= "unlike" <?php else : ?>value= "like" <?php endif ?> readonly>
                                                            <input style = "display:none" type="text" name="txttrackid" value="<?php echo $discover[0] ?>" readonly>
                                                            ...
                                                            <input style = "display:none" type="text" name="txturlid" value="like_track_<?php echo $discover[0] ?>" readonly>           
                                                            <a href="#" class="btn-favorite">
                                                                <button type="submit" name="btnLike" style="border:none;background: transparent; color: white"
                                                                <?php if (userLiked($discover[0])): ?> 
                                                                            class="likes fa fa-heart like-btn" 
                                                                        <?php else: ?> 
                                                                            class="likes fa fa-heart-o like-btn" 
                                                                        <?php endif ?> 
                                                                        data-id="<?php echo $discover[0] ?>"> 
                                                                </button>

                                                                <!--  Like Counter-->
                                                                <span class="likes counter"><?php echo getLikes($discover[0]); ?> </span>
                                                            </a>
                                                        </form>
                                                        <!-- Like END-->
                                                        ...
                                                        <div class="dropdown-menu pull-right black lt">
                                                             <a class="dropdown-item" href="add_to_queue_savedata.php?trackid=<?php echo $discover[0] ?>&url=<?php echo getCurURL() ?>"><i class="fa fa-plus fa-fw text-left"></i> Add to Queque</a>
                                                                ...
                                                                <div class="dropdown-menu pull-left dark" role="menu">
                                                                    ...
                                                                    if ($total_list_playlist > 0):
                                                                        ...
                                                                        foreach ($a_list_playlist as $list_playlist):
                                                                            ?>
                                                                            <a class="dropdown-item" href="add_to_playlist_savedata.php?playlistid=<?php echo $list_playlist[0] ?>&url=<?php echo getCurURL() ?>&trackid=<?php echo $discover[0] ?>">Add to <?php echo $list_playlist[1] ?></a>
                                                    ...
                                                    <div class="item-title text-ellipsis">
                                                        <a href="album.php?albumid=<?php echo $discover[7] ?>"><?php echo $discover[1] ?></a>
                                                    </div>
                                                    <div class="item-author text-sm text-ellipsis">
                                                        <a href="artist.detail.php?artistid=<?php echo $discover[5] ?>" class="text-muted"><?php echo $discover[6] ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } ?>
                                ...
                                <?php
                                $sql_discover = "SELECT DISTINCT TrackID, TrackName, Length, TrackFile, ImageFile, ArtistID, ArtistName, AlbumID FROM vw_track_info ORDER BY RAND() LIMIT 4";
                                $r_discover = mysqli_query($link, $sql_discover);
                                $a_discover = mysqli_fetch_all($r_discover);
                                foreach ($a_discover as $key_discover => $discover) {
                                    $number_discover = $key_discover + 1;
                                    ...
                                    <div class="col-sm-3 col-xs-6">
                                        <div class="item r" data-id="item-<?php echo $number_discover + 7 ?>" data-src="<?php echo $discover[3] ?>">
                                            <div class="item-media ">
                                                <a href="album.php?albumid=<?php echo $discover[7] ?>p" class="item-media-content" style="background-image: url('<?php echo $discover[4] ?>');"></a>
                                                <div class="item-overlay center">
                                                    <button  class="btn-playpause">Play</button>
                                                </div>
                                            </div>
                                ...
                                <div class="padding">
                                    ...
                                    <div class="owl-carousel owl-theme owl-dots-center" data-ui-jp="owlCarousel" data-ui-options="{
                                         ...
                                         items: 3
                                             ...
                                             <?php
                                             $sql_treading = "SELECT DISTINCT TrackID, TrackName, TrackFile, ArtistID, ArtistName, ImageFile, TotalListen, AlbumID FROM vw_track_listen_like_info WHERE TotalListen ORDER BY TotalListen DESC LIMIT 9";
                                             $r_treading = mysqli_query($link, $sql_treading);
                                             $a_treading = mysqli_fetch_all($r_treading);
                                             foreach ($a_treading as $key_treading => $treading) {
                                                 $number_treading = $key_treading + 1;
                                                 ?>
                                            <div class="">

                                                <div class="item r" data-id="item-<?php echo $number_treading + 7 ?>" data-src="<?php echo $treading[2] ?>">
                                                    <div class="item-media item-media-4by3">
                                                        <a href="album.php?albumid=<?php echo $treading[7] ?>" class="item-media-content" style="background-image: url('<?php $treading[5] ?>');"></a>
                                                        <div class="item-overlay center">
                                                            <button  class="btn-playpause">Play</button>
                                                        </div>
                                                    </div>
                                                    <div class="item-info">
                                                        <div class="item-overlay bottom text-right">
                                                            <!-- Like Button-->
                                                    <form action="Like_Track_savedata.php" id='like_track_<?php echo $treading[0] ?>' >
                                                        <input style = "display:none" type="text" name="txtaction" <?php if (userLiked($treading[0])): ?> value= "unlike" <?php else : ?>value= "like" <?php endif ?> readonly>
                                                        <input style = "display:none" type="text" name="txttrackid" value="<?php echo $treading[0] ?>" readonly>
                                                        <input style = "display:none" type="text" name="txtsearch" value="<?php echo $search ?>" readonly>
                                                        <input style = "display:none" type="text" name="txturl" value="<?php echo getCurURL() ?>" readonly>
                                                        <input style = "display:none" type="text" name="txturlid" value="like_track_<?php echo $treading[0] ?>" readonly>           
                                                        <a href="#" class="btn-favorite">
                                                            <button type="submit" name="btnLike" style="border:none;background: transparent; color: white"
                                                            <?php if (userLiked($treading[0])): ?> 
                                                                        class="likes fa fa-heart like-btn" 
                                                                    <?php else: ?> 
                                                                        class="likes fa fa-heart-o like-btn" 
                                                                    <?php endif ?> 
                                                                    data-id="<?php echo $treading[0] ?>"> 
                                                            </button>

                                                            <!--  Like Counter-->
                                                            <span class="likes counter"><?php echo getLikes($treading[0]); ?> </span>
                                                        </a>
                                                    </form>
                                                    <!-- Like END-->
                                                    ...
                                                    <a href="#" class="btn-more" data-toggle="dropdown"><i class="fa fa-ellipsis-h"></i></a>
                                                    <div class="dropdown-menu pull-right black lt">
                                                        <a class="dropdown-item" href="add_to_queue_savedata.php?trackid=<?php echo $treading[0] ?>&url=<?php echo getCurURL() ?>"><i class="fa fa-plus fa-fw text-left"></i> Add to Queque</a>
                                                        <div class="dropdown-item dropdown-submenu">
                                                            <a tabindex="-1" href="#"><i class="fa fa-music fa-fw text-left"></i> Add to Playlist</a>
                                                            <div class="dropdown-menu pull-left dark" role="menu">
                                                                ...
                                                                if ($total_list_playlist > 0):
                                                                    ...
                                                                    foreach ($a_list_playlist as $list_playlist):
                                                                        ?>
                                                                        <a class="dropdown-item" href="add_to_playlist_savedata.php?playlistid=<?php echo $list_playlist[0] ?>&url=<?php echo getCurURL() ?>&trackid=<?php echo $treading[0] ?>">Add to <?php echo $list_playlist[1] ?></a>
                                                    ...
                                                    <!-- Button MORE END-->
                                                        ...
                                                        <div class="item-title text-ellipsis">
                                                            <a href="album.php?albumid=<?php echo $treading[7] ?>"><?php echo $treading[1] ?></a>
                                                        </div>
                                                        <div class="item-author text-sm text-ellipsis ">
                                                            <a href="artist.detail.php?artistid=<?php echo $treading[3] ?>" class="text-muted"><?php echo $treading[4] ?></a>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <?php
                                        $sql_new = "SELECT DISTINCT `TrackID`,`TrackName`,`TrackFile`,`ArtistID`,`ArtistName`,`ImageFile`, AlbumID FROM vw_track_info WHERE `TrackID` ORDER BY `TrackID` DESC LIMIT 4";
                                        $r_new = mysqli_query($link, $sql_new);
                                        $a_new = mysqli_fetch_all($r_new);
                                        foreach ($a_new as $key_new => $new) {
                                            $number_new = $key_new + 1;
                                            ?>
                                            <div class="col-xs-4 col-sm-4 col-md-3">
                                                <div class="item r" data-id="item-<?php echo $number_new + 7 ?>" data-src="<?php echo $new[2] ?>">
                                                    <div class="item-media ">
                                                        <a href="album.php?albumid=<?php echo $new[6] ?>" class="item-media-content" style="background-image: url('<?php echo $new[5] ?>');"></a>
                                                        <div class="item-overlay center">
                                                            <button  class="btn-playpause">Play</button>
                                                        </div>
                                                    </div>
                                                    <div class="item-info">
                                                        <div class="item-overlay bottom text-right">
                                                            ...
                                                            <!-- Like Button-->
                                                            <form action="Like_Track_savedata.php" id='like_track_<?php echo $new[0] ?>' >
                                                                <input style = "display:none" type="text" name="txtaction" <?php if (userLiked($new[0])): ?> value= "unlike" <?php else : ?>value= "like" <?php endif ?> readonly>
                                                                <input style = "display:none" type="text" name="txttrackid" value="<?php echo $new[0] ?>" readonly>
                                                                <input style = "display:none" type="text" name="txtsearch" value="<?php echo $search ?>" readonly>
                                                                <input style = "display:none" type="text" name="txturl" value="<?php echo getCurURL() ?>" readonly>
                                                                <input style = "display:none" type="text" name="txturlid" value="like_track_<?php echo $new[0] ?>" readonly>           
                                                                <a href="#" class="btn-favorite">
                                                                    <button type="submit" name="btnLike" style="border:none;background: transparent; color: white"
                                                                    <?php if (userLiked($new[0])): ?> 
                                                                                class="likes fa fa-heart like-btn" 
                                                                            <?php else: ?> 
                                                                                class="likes fa fa-heart-o like-btn" 
                                                                            <?php endif ?> 
                                                                            data-id="<?php echo $new[0] ?>"> 
                                                                    </button>

                                                                    <!--  Like Counter-->
                                                                    <span class="likes counter"><?php echo getLikes($new[0]); ?> </span>
                                                                </a>
                                                            </form>
                                                            <!-- Like END-->
                                                            ...
                                                            <a href="#" class="btn-more" data-toggle="dropdown"><i class="fa fa-ellipsis-h"></i></a>
                                                            <div class="dropdown-menu pull-right black lt">
                                                                 <a class="dropdown-item" href="add_to_queue_savedata.php?trackid=<?php echo $new[0] ?>&url=<?php echo getCurURL() ?>"><i class="fa fa-plus fa-fw text-left"></i> Add to Queque</a>
                                                                <div class="dropdown-item dropdown-submenu">
                                                                    <a tabindex="-1" href="#"><i class="fa fa-music fa-fw text-left"></i> Add to Playlist</a>
                                                                    <div class="dropdown-menu pull-left dark" role="menu">
                                                                        ...
                                                                        if ($total_list_playlist > 0):
                                                                            ...
                                                                            foreach ($a_list_playlist as $list_playlist):
                                                                                ?>
                                                                                <a class="dropdown-item" href="add_to_playlist_savedata.php?playlistid=<?php echo $list_playlist[0] ?>&url=<?php echo getCurURL() ?>&trackid=<?php echo $new[0] ?>">Add to <?php echo $list_playlist[1] ?></a>
                                                        ...
                                                        <div class="item-title text-ellipsis">
                                                            <a href="album.php?albumid=<?php echo $new[6] ?>"><?php echo $new[1] ?></a>
                                                        </div>
                                                        <div class="item-author text-sm text-ellipsis ">
                                                            <a href="artist.detail.php?artistid=<?php echo $new[3] ?>" class="text-muted"><?php echo $new[4] ?></a>
                                                        </div>
                                    ...
                                    <div class="row item-list item-list-md m-b">
                                        <?php
                                        $sql_foryou = "SELECT DISTINCT TrackID, TrackName, TrackFile, ArtistID, ArtistName, ImageFile, TypeID, TypeName, UserID, AlbumID FROM vw_track_liked_user WHERE UserID = '$userid' ORDER BY TypeID LIMIT 8";
                                        $r_foryou = mysqli_query($link, $sql_foryou);
                                        $a_foryou = mysqli_fetch_all($r_foryou);
                                        foreach ($a_foryou as $key_foryou => $foryou) {
                                            $number_foryou = $key_foryou + 1;
                                            ?>
                                            <div class="col-sm-6">
                                                <div class="item r" data-id="item-<?php echo $number_foryou + 7 ?>" data-src="<?php echo $foryou[2] ?>">
                                                    <div class="item-media ">
                                                        <a href="album.php?albumid=<?php echo $foryou[9] ?>" class="item-media-content" style="background-image: url('<?php echo $foryou[5] ?>');"></a>
                                                        <div class="item-overlay center">
                                                            <button  class="btn-playpause">Play</button>
                                                        </div>
                                                    </div>
                                                    <div class="item-info">
                                                        <div class="item-overlay bottom text-right">
                                                            ...
                                                            <!-- Like Button-->
                                                            <form action="Like_Track_savedata.php" id='like_track_<?php echo $foryou[0] ?>' >
                                                                <input style = "display:none" type="text" name="txtaction" <?php if (userLiked($foryou[0])): ?> value= "unlike" <?php else : ?>value= "like" <?php endif ?> readonly>
                                                                <input style = "display:none" type="text" name="txttrackid" value="<?php echo $foryou[0] ?>" readonly>
                                                                <input style = "display:none" type="text" name="txtsearch" value="<?php echo $search ?>" readonly>
                                                                <input style = "display:none" type="text" name="txturl" value="<?php echo getCurURL() ?>" readonly>
                                                                <input style = "display:none" type="text" name="txturlid" value="like_track_<?php echo $foryou[0] ?>" readonly>           
                                                                <a href="#" class="btn-favorite">
                                                                    <button type="submit" name="btnLike" style="border:none;background: transparent; color: white"
                                                                    <?php if (userLiked($foryou[0])): ?> 
                                                                                class="likes fa fa-heart like-btn" 
                                                                            <?php else: ?> 
                                                                                class="likes fa fa-heart-o like-btn" 
                                                                            <?php endif ?> 
                                                                            data-id="<?php echo $foryou[0] ?>"> 
                                                                    </button>

                                                                    <!--  Like Counter-->
                                                                    <span class="likes counter"><?php echo getLikes($foryou[0]); ?> </span>
                                                                </a>
                                                            </form>
                                                            <!-- Like END-->
                                                                ...
                                                                <div class="dropdown-item dropdown-submenu">
                                                                    ...
                                                                    <div class="dropdown-menu pull-left dark" role="menu">
                                                                        ...
                                                                        if ($total_list_playlist > 0):
                                                                            ...
                                                                            foreach ($a_list_playlist as $list_playlist):
                                                                                ?>
                                                                                <a class="dropdown-item" href="add_to_playlist_savedata.php?playlistid=<?php echo $list_playlist[0] ?>&url=<?php echo getCurURL() ?>&trackid=<?php echo $foryou[0] ?>">Add to <?php echo $list_playlist[1] ?></a>
                                                        ...
                                                        <div class="item-title text-ellipsis">
                                                            <a href="album.php?albumid=<?php echo $foryou[9] ?>"><?php echo $foryou[1] ?></a>
                                                        </div>
                                                        <div class="item-author text-sm text-ellipsis ">
                                                            <a href="artist.detail.php?artistid=<?php echo $foryou[3] ?>" class="text-muted"><?php echo $foryou[4] ?></a>
                                                        </div>
                                                        ...
                                                        foreach ($a_list_track as $key_track => $track) {
                                                            ...
                                                            <div class="col-xs-12">
                                                                <div class="item r" data-id=<?php echo "item-$number_track"; ?> data-src=<?php echo "$track[4]"; ?>>
                                                                    <div class="item-media ">
                                                                        <a href="track.detail.php" class="item-media-content" style="background-image: url(<?php echo '$track[2]' ?>);"></a>
                                                                    </div>
                                                                    <div class="item-info">
                                                                        <div class="item-title text-ellipsis">
                                                                            <a href="track.detail.php"><?php echo $track[0]; ?></a>
                                                                        </div>
                                                                        <div class="item-author text-sm text-ellipsis ">
                                                                            <a href="artist.detail.php" class="text-muted"><?php echo $track[1]; ?></a>
                                                                        </div>
                                                            ...
                                                            <div class="col-xs-12">
                                                                <div class="item">
                                                                    <div class="item-media rounded ">
                                                                        <a href="artist.detail.php" class="item-media-content" style="background-image: url('<?php echo $artist[1]; ?>');"></a>
                                                                    </div>
                                                                    <div class="item-info ">
                                                                        <div class="item-title text-ellipsis">
                                                                            <a href="artist.detail.php"><?php echo $artist[0]; ?></a>
