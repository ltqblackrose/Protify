                                ...
                                <div class="padding">
                                    ...
                                    <div class="page-title m-b">
                                        ...
                                        <div class="dropdown inline">
                                            <?php
                                            $sql_list_type = "SELECT TypeID, TypeName FROM tb_type WHERE TypeID = $type_c";
                                            $r_list_type = mysqli_query($link, $sql_list_type);
                                            $a_list_type = mysqli_fetch_all($r_list_type);
                                            foreach ($a_list_type as $list_type) {
                                                ?>
                                                <button class="btn btn-sm no-bg h4 m-y-0 v-b dropdown-toggle text-primary" data-toggle="dropdown" data-id="<?php echo $list_type[0] ?>"><?php echo $list_type[1] ?></button>
                                                <?php
                                            }
                                            ?>
                                            <div class="dropdown-menu">
                                                ...
                                                $q_type = mysqli_query($link, $sql_type);
                                                $a_type = mysqli_fetch_all($q_type);
                                                foreach ($a_type as $l_type) {
                                                    ?>
                                                    <a href="type_1.php?typeID=<?php echo $l_type[0] ?>" class="dropdown-item">
                                                        <?php echo $l_type[1]; ?>
                                                    </a>
                                                <?php } ?>
                                            </div>
                                    ...
                                    <div class="row">
                                        <?php
                                        $qr = " select TrackID, TrackName, Length, TrackFile, ImageFile, ArtistID, ArtistName, AlbumID from vw_track_info where TypeID = $type_c";

                                        $r_list_tracktype = mysqli_query($link, $qr);
                                    ...
                                    <div class="text-center">
                                        <a href="scroll_item(1).php" class="btn btn-sm white rounded jscroll-next">Show More</a>
                                    </div>
