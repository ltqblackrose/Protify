                            ...
                            <div class="col-lg-9 b-r no-border-md">
                                <div class="padding">
                                    ...
                                    <div class="page-title m-b">
                                        ...
                                        <div class="dropdown inline">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="browse.php" class="dropdown-item active">
                                                    All
                                                </a>
                                    ...
                                    <div data-ui-jp="jscroll" data-ui-options="{
                                        ...
                                        <div class="row">
                                            <?php
                                            $sql_tracktype = "SELECT DISTINCT Trackid, TrackName, Length, TrackFile, ImageFile, Artistid, ArtistName, albumid FROM vw_track_info LIMIT 0,8";
