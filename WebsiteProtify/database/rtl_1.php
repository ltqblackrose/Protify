                            ...
                            <div class="col-lg-9 b-r no-border-md">
                                <div class="padding">
                                    ...
                                    <div class="row item-list item-list-md m-b">
                                        <?php
                                        $sql_foryou = "SELECT DISTINCT TrackID, TrackName, TrackFile, ArtistID, ArtistName, ImageFile, TypeID, TypeName, UserID, AlbumID FROM vw_track_liked_user WHERE UserID= '$userid' ORDER BY UserID LIMIT 8";
                                        ...
                                        foreach ($a_foryou as $key_foryou => $foryou) {
                                            ...
                                            <div class="col-sm-6">
                                                <div class="item r" data-id="item-<?php echo $number_foryou + 7 ?>" data-src="<?php echo $foryou[2] ?>">
                                                    <div class="item-media ">
                                                        <a href="track.detail.php?TrackID=<?php echo $foryou[0] ?>" class="item-media-content" style="background-image: url('<?php echo $foryou[5] ?>');"></a>
                                                        <div class="item-overlay center">
                                                            <button  class="btn-playpause">Play</button>
                                                        </div>
                                                    </div>
                                                    <div class="item-info">
                                                        <div class="item-overlay bottom text-right">
                                                            <!-- Like Button-->
                                                            <form class= "btn-favorite" action="Like_Track_savedata.php" id='like_track_<?php echo $foryou[0] ?>' >
