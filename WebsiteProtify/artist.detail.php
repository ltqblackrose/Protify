...
$artistid = isset($_GET["artistid"]) ? $_GET["artistid"] : 1;
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                        ...
                        <div class="nav-fold dropup">
                            <a data-toggle="dropdown">
                                ...
                                <span class="clear hidden-folded p-x p-y-xs">
                                    <span class="block _500 text-ellipsis">Võ Minh Thư</span>
                                </span>
                            </a>
                ...
                <div class="app-body" id="view">
                    ...
                    <div class="page-content">
                        <div class="padding b-b">
                            <div class="row-col">
                                <?php
                                $sql_artist_detail = "select artistid,artistname,totalalbum,totaltrack,trackfile,imagefile,note from vw_artist_info where artistid=$artistid";
                                $r_artist_detail = mysqli_query($link, $sql_artist_detail);
                                $total_artist_detail = mysqli_num_rows($r_artist_detail);

                                $a_artist_detail = mysqli_fetch_all($r_artist_detail);
                                $artist_detail = $a_artist_detail[0];
                                ?>
                                <div class="col-sm w w-auto-xs m-b">
                                    <div class="item w rounded"> 
                                        ...
                                        <div class="item-media">
                                            <div class="item-media-content" style="background-image: url('<?php echo $artist_detail[5] ?>');"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm">
                                    <div class="p-l-md no-padding-xs">
                                        <div class="page-title">
                                            <h1 class="inline"><?php echo $artist_detail[1] ?></h1>
                                            <label class="fa fa-star text-primary text-lg m-b v-m m-l-xs" title="Pro"></label>
                                        </div>
                                        <p class="item-desc text-ellipsis text-muted" data-ui-toggle-class="text-ellipsis"><?php echo $artist_detail[6] ?></p>
                                        <div class="item-action m-b">
                                            ...
                                            <span><?php echo $artist_detail[3] ?> Track, <?php echo $artist_detail[2] ?> Album</span>
                                        </div> 

                                        <div class="block clearfix m-b"> 

                                            <a class="btn btn-xs rounded white"><?php echo $artist_detail[1] ?></a> <a class="btn btn-xs rounded white"><?php echo $artist_detail[4] ?></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="padding">
                                    <div class="nav-active-border b-primary bottom m-b-md">
                                        <ul class="nav l-h-2x">
                                            ...
                                            <li class="nav-item m-r inline">
                                                <a class="nav-link" href="#" data-toggle="tab" data-target="#tab_3">Albums</a>
                                            </li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id=    "tab_1">
                                            ...
                                            <?php
                                            $sql_artist_detail = "select Trackid, TrackName, Artistid, ArtistName, TrackFile from vw_track_info where Artistid = $artistid LIMIT 0,6 ;";
                                            $r_artist_detail = mysqli_query($link, $sql_artist_detail);
                                            $a_artist_detail = mysqli_fetch_all($r_artist_detail);
                                            ?>
                                            <div class="row item-list item-list-md item-list-li m-b" id="tracks">     
                                                <?php
                                                foreach ($a_artist_detail as $key => $artist) {
                                                    ?>
                                                    <div class="col-md-12 col-lg-6"> 

                                                        <div class="item r" data-id="item-11" data-src="<?php echo $artist[4] ?>">
                                                            <div class="item-media ">
                                                                <a href="track.detail.php" class="item-media-content" style="background-image: url('images/b10.jpg');"></a>
                                                            ...
                                                            <div class="item-info">
                                                                ...
                                                                <div class="item-title text-ellipsis">
                                                                    <a href=""><?php echo $artist["1"] ?></a>
                                                                </div>
                                                                <div class="item-author text-sm text-ellipsis hide">
                                                                    <a href="artist.detail.php" class="text-muted"><?php echo $artist[3] ?></a>
                                                                </div>
                                            ...
                                            <div class="row m-b">
                                                    ...
                                                    <?php
                                                    $sql_artist_album = "select artistid,artistname,albumid,albumname,trackfile,imagefile,totallisten,totalliked from vw_album_info where Artistid=$artistid LIMIT 0,3;";
                                                    ...
                                                    ?>
                                                </div>                                                <a href="#" class="btn btn-sm white rounded">Show More</a>

                                            </div>
                                            <div class="tab-pane" id="tab_2">
                                                <?php
                                                $sql_artist_track = "select trackid, trackname, artistid, artistname, trackfile, imagefile, totalliked, totallisten, albumid from vw_track_listen_like_info where artistid = $artistid";
                                                $r_artist_track = mysqli_query($link, $sql_artist_track);
                                                $total_artist_track = mysqli_num_rows($r_artist_track);
                                                if ($total_artist_track > 0) :
                                                    ?>
                                                    <div class="row m-b">
                                                        <?php
                                                        $a_artist_track = mysqli_fetch_all($r_artist_track);
                                                        foreach ($a_artist_track as $key_artist_track => $artist_track) :
                                                            $number_artist_track = $key_artist_track + 1;
                                                            ?>
                                                            <div class="col-xs-4 col-sm-4 col-md-3">

                                                                <div class="item r" data-id="item-<?php echo $number_artist_track + 2 ?>" data-src="<?php echo $artist_track[4] ?>">
                                                                    <div class="item-media ">
                                                                        <a href="#" class="item-media-content" style="background-image: url('<?php echo $artist_track[5] ?>');"></a>
                                                                        <div class="item-overlay center">
                                                                            <button  class="btn-playpause">Play</button>
                                                                        </div>
                                                                    </div>
                                                                    <div class="item-info">
                                                                        ...
                                                                        <div class="item-title text-ellipsis">
                                                                            <a href="album.php?albumid=<?php echo $artist_track[8] ?>"><?php echo $artist_track[1] ?></a>
                                                                        </div>
                                                                        <div class="item-author text-sm text-ellipsis hide">
                                                                            <a href="artist.detail.php?artistid=<?php echo $artistid ?>" class="text-muted"><?php echo $artist_track[3] ?></a>
                                                                        </div>
                                                                        <div class="item-meta text-sm text-muted">
                                                                            <span class="item-meta-stats text-xs ">
                                                                                <i class="fa fa-play text-muted"></i> <?php echo $artist_track[7] ?> 
                                                                                <i class="fa fa-heart m-l-sm text-muted"></i> <?php echo $artist_track[6] ?>
                                                                            </span>
                                                                        </div>
                                            ...
                                            <div class="tab-pane" id="tab_3">
                                                <?php
                                                $sql_artist_album = "select Albumid, AlbumName, Artistid, ArtistName, TrackFile, AlbumID, ImageFile from vw_album_info where ArtistID = $artistid ;";
                                                $r_artist_album = mysqli_query($link, $sql_artist_album);
                                                $a_artist_album = mysqli_fetch_all($r_artist_album);
                                                ?>
                                                <div class="row m-b">
                                                    <?php
                                                    foreach ($a_artist_album as $key => $artist) {
                                                        ?>
                                                        <div class="col-xs-4 col-sm-4 col-md-3">
                                                            <div class="item r" data-id="item-9" data-src="<?php echo $artist[4] ?>">
                                                                <div class="item-media ">
                                                                    <a href="album.php?albumid=<?php echo $artist[5] ?>" class="item-media-content" style="background-image: url('<?php echo $artist[6] ?>');"></a>
                                                                    <div class="item-overlay center">
                                                                        <button  class="btn-playpause">Play</button>
                                                                    </div>
                                                                </div>
                                                                <div class="item-info">
                                                                    ...
                                                                    <div class="item-title text-ellipsis">
                                                                        <a href="album.php?albumid=<?php echo $artist[5] ?>"><?php echo $artist[1] ?></a>
                                                                    </div>
                                                                    <div class="item-author text-sm text-ellipsis hide">
                                                                        <a href="artist.detail.php?artistid=<?php echo $artistid ?>" class="text-muted"><?php echo $artist[3] ?></a>
                                                                    </div>
                                                                    <div class="item-meta text-sm text-muted">
                                                                        <span class="item-meta-stats text-xs ">
                                                                            <i class="fa fa-play text-muted"></i> 4500 
