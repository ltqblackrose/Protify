...
<html lang="en">
        ...
        <div class="app dk" id="app">
            ...
            <div id="content" class="app-content white bg box-shadow-z2" role="main">
                ...
                <div class="app-body" id="view">
                    ...
                    <!-- ############ PHP START-->
                    <?php
                    $sql_playlist = "select Playlistid,Playlistname,CreateDate,ImageFile,Note,totalListen,totalLiked,totalTrack,totalLength,userid from vw_playlist_info where playlistid=$playlistid;";
                    $r_list_playlist = mysqli_query($link, $sql_playlist);
                    $a_list_playlist = mysqli_fetch_all($r_list_playlist);
                    $playlist = $a_list_playlist[0];

                    $userid_playlist = $playlist[9];
                    ...
                    <div class="pos-rlt">
                        ...
                        <div class="page-bg" data-stellar-ratio="2" style="background-image: url('<?php echo $playlist[3] ?>');"></div>
                    </div>
                                ...
                                <div class="col-sm w w-auto-xs m-b">
                                    <div class="item w r">
                                        <div class="item-media">
                                            <div class="item-media-content" style="background-image: url('<?php echo $playlist[3] ?>');"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="p-l-md no-padding-xs">
                                        <div class="page-title">
                                            <h1 class="inline"><?php echo $playlist[1] ?></h1>
                                        </div>

                                        <p class="item-desc text-ellipsis text-muted" data-ui-toggle-class="text-ellipsis"><?php echo $playlist[4] ?></p>
                                        <div class="item-action m-b">
                                            ...
                                            <span class="text-muted"><?php echo $playlist[5] ?></span>
                                            <a class="btn btn-icon rounded btn-favorite"><i class="fa fa-heart"></i></a> 
                                            <span class="text-muted"><?php echo $playlist[6] ?></span>
                            ...
                            <div class="col-lg-9 b-r no-border-md">
                                ...
                                <div class="padding">
                                    ...
                                    <h6 class="m-b">
                                        ...
                                        <a href="profile.php" data-pjax class="item-author _600"><?php echo $playlist[2] ?></a> 
                                        <span class="text-muted text-sm">- <?php echo $playlist[7] ?> song, <?php echo date('i', strtotime($playlist[8])) ?> minutes <?php echo date('s', strtotime($playlist[8])) ?> seconds </span>
                                    </h6>
                                    ...
                                    <div id="tracks" class="row item-list item-list-xs item-list-li m-b">
                                        <?php
                                        $sql_track = "select Trackid, TrackName, Length, TrackFile, ImageFile, Artistid, Albumid, ArtistName,createduser from vw_track_playlist_info where playlistid=$playlistid;";
                                        ...
                                        foreach ($a_list_track as $key_track => $track) :
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="item r" data-id="item-<?php echo $number_track + 7 ?>" data-src="<?php echo $track[3] ?>">
                                                    <div class="item-media ">
                                                        <a href="album.php?albumid=<?php echo $track[6] ?>" class="item-media-content" style="background-image: url('<?php echo $track[4] ?>');"></a>
    ...
    <!--                                                                            <span class="likes counter"><?php echo getLikes($track[0]); ?> </span>-->
                                                                ...
                                                                <div class="dropdown-menu pull-right black lt">
                                                                    ...
                                                                    <?php if($userid==$track[8]): ?>
                                                                    <a class="dropdown-item" href="delete_track_playlist_savedata.php?trackid=<?php echo $track[0] ?>&playlistid=<?php echo $playlistid?>&url=<?php echo getCurURL() ?>"><i class="fa fa-minus fa-fw text-left"></i> Delete from Playlist</a>
                                                                    <?php endif ?>
                                    ...
                                    <h5 class="m-b"> Other playlists created by user :  <?php echo $userid_playlist ?> </h5>
                                    <div class="row m-b">
                                        <?php
                                        $sql_user_playlist = "select userid,createDate,playlistid,playlistname,trackfile,imagefile,totallisten,totalliked from vw_playlist_info where Userid='$userid_playlist';";
                                            ...
                                            <div class="col-xs-6 col-sm-6 col-md-3">
                                                <div class="item r" data-id="item- <?php echo $number_user_playlist + 12 ?>" data-src="<?php echo $user_playlist[4] ?>">
                                                    ...
                                                    <div class="item-info">
                                                        ...
                                                        <div class="item-title text-ellipsis">
                                                            <a href="playlist.detail.php.php?playlistid=<?php echo $user_playlist[2] ?>"><?php echo $user_playlist[3] ?></a>
                                                        </div>
                                                        <div class="item-author text-sm text-ellipsis hide">
                                                            <a hre f="artist.detail.php?artistid=<?php echo $userid ?>" class="text-muted"><?php echo $user_playlist[1] ?></a>
                                                        </div>
                                                        <div class="item-meta text-sm text-muted">
                                    ...
                                    <div class="streamline m-b m-l">
                                        ...
                                        $page_comment = 1;
                                        $limit_comment = 5;
                                        $sql_checkcomment = "select Cmtid from vw_cmt_info where playlistid=$playlistid&CmtType='playlist' order by datetime desc ;";
                                        ...
                                        if ($total_comment > 0) {
                                            ...
                                            $sql_comment = "select Cmtid, Playlistid,Userid,Name,CmtEmail,RealEmail,Content,DateTime,ImageFile from vw_cmt_info where playlistid=$playlistid&CmtType='playlist' order by datetime desc limit $start_comment,$limit_comment;";
                                            ...
                                            foreach ($a_comment as $key_comment => $comment) :
                                                ...
                                                ?>
                                                <div class="sl-item" id="comment_<?php echo $comment[0] ?>">
                                                    <div class="sl-left ">
                                                    ...
                                                    <div class="sl-content">
                                                        ...
                                                        <div class="box collapse m-a-0 b-a" id="reply-<?php echo $number_comment ?>">
                                                            <form action="reply_playlist_savedata.php?playlistid=<?php echo $playlistid ?>">
                                        ...
                                        <ul class="pagination">
                                            ...
                                            <?php for ($i = 1; $i <= $total_page_comment; $i++) { ?>
                                                <li <?php if ($page_comment == $i) echo "class='active'"; ?> ><a href="playlist.detail.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                            <?php } ?>
                                    ...
                                    <form action="comment_playlist_savedata.php?playlistid=<?php echo $playlistid ?>">
                                        <input type="number" style="display:none" name="txtAlbumid" id="txtCmtid" value=<?php echo $playlistid; ?> class="text" readonly="">
