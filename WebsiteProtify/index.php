    ...
    <div class="app-header navbar-md black box-shadow-z1">
        <div class="navbar" data-pjax>
              ...
              <?php 
                ...
                <li class="nav-item">
                    <a href="signout.php" class="nav-link"onclick="return confirm('Are you sure ?')">
                    <span class="btn btn-sm  rounded warning _600">
                    Signout
                      </span>
                  </a>
                </li>
              ...
              <ul class="nav navbar-nav pull-right">
                <li class="nav-item">
                  <a href="signup.php" class="nav-link">
                      <span class="btn btn-sm  rounded accent _600">
                    Signup
                      </span>
                  </a>
                </li>
...
<div class="owl-carousel black owl-theme owl-dots-bottom-center" data-ui-jp="owlCarousel" data-ui-options="{
	...
	<div class="row-col">
		...
		<div class="col-lg-8 text-center">
			<div class="p-a-lg">
				<h2 class="display-4 m-y-lg">Welcome to my our music streaming</h2>
				<h6 class="text-muted m-b-lg">Protify</h6>
				<a href="home.php" class="btn circle btn-outline b-primary m-b-lg p-x-md">Get it now</a>
			</div>
		</div>
		<div class="col-lg-2"></div>
	</div>
	<div class="row-col">
		...
		<div class="col-lg-8 text-center">
			<div class="p-a-lg">
				<h2 class="display-4 m-y-lg">Try our Music Streming Web App</h2>
				<h6 class="text-muted m-b-lg">Protifyt</h6>
				<a href="player.php" class="btn circle btn-outline b-primary m-b-lg p-x-md">View App</a>
			</div>
		</div>
		<div class="col-lg-2"></div>
	</div>
	<div class="row-col">
		...
		<div class="col-lg-8 text-center">
			<div class="p-a-lg">
				<h2 class="display-4 m-y-lg">Try our RTL Web</h2>
				<h6 class="text-muted m-b-lg">Protify</h6>
				<a href="rtl.php" class="btn circle btn-outline b-primary m-b-lg p-x-md">Get RTL</a>
			</div>
		</div>
		<div class="col-lg-2"></div>
	</div>
	...
	<div class="col-sm-6">
		<div class="black cover cover-gd" style="background-image: url('images/b1.jpg');">
			<div class="p-a-lg text-center">
				...
				<a href="player.php" class="btn circle white m-b-lg p-x-md">Try Free</a>
			</div>
		</div>
	</div>
	<div class="col-sm-6 black lt">
		<div class="black cover cover-gd" style="background-image: url('images/b7.jpg');">
			<div class="p-a-lg text-center">
				...
				<a href="home.php" class="btn circle white m-b-lg p-x-md">View Artists</a>
			</div>
		</div>
	</div>
</div>
...
<div class="row-col dark-white">
	...
	<div class="col-md-6">
		<div class="p-a-lg text-center">
			...
			<a href="home.php" class="btn circle btn-outline b-black m-b-lg p-x-md">Try Settings</a>
		</div>
	</div>
	<div class="col-md-3"></div>
</div>
...
<div class="black cover" data-stellar-background-ratio="0.5" style="background-image: url('images/b10.jpg');">
	<div class="row-col">
		<div class="col-md-4">
			<div class="p-a-lg text-center">
				<h4 class="m-y-lg">Listen music and release all your stress</h4>
				<p class="text-muted text-md m-b-lg">Protify</p>
			</div>
		</div>
		<div class="col-md-4">
			<div class="p-a-lg text-center">
