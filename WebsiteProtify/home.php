                                            ...
                                            <div class="item r" data-id="item-<?php echo $number_discover + 7 ?>" data-src="<?php echo $discover[3] ?>">
                                                ...
                                                <div class="item-info">
                                                    ...
                                                    <div class="item-title text-ellipsis">
                                                        <a href="track.detail.php?TrackID=<?php echo $discover[0] ?>"><?php echo $discover[1] ?></a>
                                                    </div>
                                    ...
                                    <div class="col-sm-3 col-xs-6">
                                        <div class="item r" data-id="item-1" data-src="http://api.soundcloud.com/tracks/269944843/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
                                            <div class="item-media ">
                                                <a href="track.detail.php" class="item-media-content" style="background-image: url('images/b0.jpg');"></a>
                                                <div class="item-overlay center">
                                                    <button  class="btn-playpause">Play</button>
                                                </div>
                                            </div>
                                            <div class="item-info">
                                                ...
                                                <div class="item-title text-ellipsis">
                                                    <a href="track.detail.php">Pull Up</a>
                                                </div>
                                                <div class="item-author text-sm text-ellipsis ">
                                                    <a href="artist.detail.php" class="text-muted">Summerella</a>
                                                </div>
                                            ...
                                            <div class="">
                                                <div class="item r" data-id="item-<?php echo $number_treading + 7 ?>" data-src="<?php echo $treading[2] ?>">
                                                    <div class="item-media item-media-4by3">
                                                        <a href="track.detail.php?TrackID=<?php echo $treading[0] ?>" class="item-media-content" style="background-image: url('<?php $treading[5] ?>');"></a>
                                                        <div class="item-overlay center">
                                                            <button  class="btn-playpause">Play</button>
                                                        </div>
                                                    </div>
