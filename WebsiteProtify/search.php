...
<html lang="en">
    ...
    <!--                                                                            <span class="likes counter"><?php echo getLikes($track[0]); ?> </span>-->
                                                                ...
                                                                <div class="dropdown-menu pull-right black lt">
                                                                    <a class="dropdown-item" href="add_to_queue_savedata.php?trackid=<?php echo $track[0] ?>&url=<?php echo getCurURL() ?>"><i class="fa fa-plus fa-fw text-left"></i> Add to Queque</a>
                                ...
                                <div>
                                    ...
                                    <ul class="pagination">
                                        ...
                                        <?php for ($i = 1; $i <= $total_page_track; $i++) { ?>
                                            <li <?php if ($page_track == $i) echo "class='active'"; ?> ><a href="searchresult_1.php?page=<?php echo $i; ?>&IPSearch=<?php echo $search; ?>"><?php echo $i; ?></a></li>
                                        <?php } ?>
                                    ...
                                    foreach ($a_list_album as $key_album => $album) {
                                        ...
                                        <div class="col-xs-12">
                                            <div class="item r" data-id=<?php echo "item-$number_album"; ?> data-src=<?php echo "$album[4]"; ?>>
                                                <div class="item-media">
                                                    <a href="album.php?albumid=<?php echo $album[5]?>" class="item-media-content" style="background-image: url('<?php echo $album[2] ?>');"></a>
                                                    <div class="item-overlay center">
                                                        <button  class="btn-playpause">Play</button>
                                                    </div>
                                                </div>
                                                <div class="item-info">
                                                    ...
                                                    <div class="item-author text-sm text-ellipsis ">
                                                        ...
                                                        <a href="artist.detail.php?artistid=<?php echo $album[5]?>" class="text-muted"><?php echo $album[1]; ?></a>
                                                    </div>
                                                    <div class="item-meta text-sm text-muted">
                                                        <span class="item-meta-tag visible-list"><a href="browse.php"></a></span>
                                                    </div>
                                ...
                                <div>
                                    ...
                                    <ul class="pagination">
                                        ...
                                        <?php for ($i = 1; $i <= $total_page_album; $i++) { ?>
                                            <li <?php if ($page_album == $i) echo "class='active'"; ?> ><a href="searchresult_1.php?page=<?php echo $i; ?>&IPSearch=<?php echo $search; ?>"><?php echo $i; ?></a></li>
                                        <?php } ?>
                                        <li><a href="#"><i class="fa fa-chevron-right"></i></a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-md-8 offset-md-2">
                               ...
                               <?php if ($search!='KhongCoDuLieu') :?>
                                <div id="search-result" class="animated fadeIn">
                                    <p class="m-b-md"><strong><?php echo $total_track+$total_album+$total_artist ?></strong> <span class="text-muted">Results found for: </span><strong><?php echo $search ?></strong></p>
                                    <div class="row">
                                        <?php
                                        if ($total_track > 0) {
                                            $sql_listsearch_track = "select trackname,ArtistName,ImageFile,Note,TrackFile,trackid, from vw_track_info where trackname like '%$search%' limit 0,4;";
                                            $r_list_track = mysqli_query($link, $sql_listsearch_track);
                                            $a_list_track = mysqli_fetch_all($r_list_track);
                                            ?>
                                            <div class="col-sm-6">
