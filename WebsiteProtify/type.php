                                ...
                                <div class="padding">
                                    ...
                                    <div class="page-title m-b">
                                        ...
                                        <div class="dropdown inline">
                                            <?php
                                            $sql_list_type = "SELECT TypeID, TypeName FROM tb_type WHERE TypeID = $type";
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                foreach ($a_type as $l_type) {
                                                    ?>
                                                    <a href="type.php?typeID=<?php echo $l_type[0] ?>" class="dropdown-item">
                                                        <?php echo $l_type[1]; ?>
                                                    </a>
                                                <?php } ?>
                                            </div>
                                    ...
                                    <div class="row">
                                        <?php
                                        $qr = " select TrackID, TrackName, Length, TrackFile, ImageFile, ArtistID, ArtistName, AlbumID from vw_track_info where TypeID = $type";
