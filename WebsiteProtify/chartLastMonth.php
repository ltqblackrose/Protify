                                ...
                                <div class="padding">
                                    ...
                                    <div class="page-title m-b">
                                        ...
                                        <div class="dropdown inline">
                                            <button class="btn btn-sm no-bg h4 m-y-0 v-b dropdown-toggle text-primary" data-toggle="dropdown">Last month</button>
                                    ...
                                    <?php
                                    $sql =  "SELECT TrackName, sum(TotalListen), trackfile, ImageFile, TrackID, ArtistName, ArtistID, TotalLiked, ArtistID, AlbumID FROM vw_track_listen_date_info WHERE extract(YEAR_MONTH FROM Date) = extract(YEAR_MONTH FROM CURRENT_DATE)- 1 group by TrackID ORDER BY TotalListen DESC, TrackName ASC LIMIT 10";
                                    $r = mysqli_query($link, $sql);
                                    $char = mysqli_fetch_all($r);
                                    foreach ($char as $songs) {
                                        ?>

                                    <div class="row item-list item-list-md item-list-li m-b">
                                            <div class="col-xs-12">
                                                <div class="item r" data-id="<?php echo $songs[4] ?>" data-src="<?php echo $songs[2] ?>">
                                                    <div class="item-media ">
                                                        ...
                                                        <div class="item-overlay center">
                                                            <button  class="btn-playpause" onclick="load_ajax(<?php echo $songs[4] ?>)">Play</button>
                                                        </div>
                                                    </div>
                                                    <div class="item-info">
