                ...
                <div class="app-body" id="view">
                    ...
                    <div class="page-content">
                        <div class="padding b-b">
                            <?php
                            $sql6 = "SELECT UserID, Avt, story FROM tb_user WHERE UserID = '$userid'";
                            $query6 = mysqli_query($link, $sql6);
                            $user = mysqli_fetch_row($query6);
                            ?>
                            <div class="row-col">
                                <div class="col-sm w w-auto-xs m-b">
                                    <div class="item w rounded">
                                        <div class="item-media">
                                            <div class="item-media-content" style="background-image: url('<?php echo $user[1] ?>');"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="p-l-md no-padding-xs">
                                        ...
                                        <div class="item-action m-b">
                                            ...
                                            <a href="manageUser.php" class="btn btn-sm rounded primary">Manage profile</a>
                                        </div>
                                ...
                                <div class="padding p-y-0 m-b-md">
                                    <div class="nav-active-border b-primary bottom m-b-md m-t">
                                        <ul class="nav l-h-2x" data-ui-jp="taburl">
                                            <li class="nav-item m-r inline">
                                                <a class="nav-link active" href="profile.php#queue" data-toggle="tab" data-target="#queue">Queue</a>
                                            </li>
                                            <li class="nav-item m-r inline">
                                                <a class="nav-link" href="profile.php#playlists" data-toggle="tab" data-target="#playlist">Playlists</a>
                                            </li>
                                            <li class="nav-item m-r inline">
                                                <a class="nav-link" href="profile.php#likes" data-toggle="tab" data-target="#like">Likes</a>
                                            </li>
                                            <li class="nav-item m-r inline">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="queue"> 
                                            <?php
                                            $sql2 = "SELECT a.TrackID, b.TrackName, b.Desc, b.ImageFile, b.TrackFile, b.ReleaseDate, b.Desc FROM tb_queue_track a INNER JOIN tb_track b on a.TrackID = b.TrackID WHERE a.UserID = '$userid' ";
                                                ...
                                                <div class="row item-list item-list-by m-b">
                                                    <div class="col-xs-12">
                                                        <div class="item r" data-id="<?php echo $song[0] ?>" data-src="<?php echo $song[4] ?>">
                                                            <div class="item-media ">
                                                                <a href="track.detail.html" class="item-media-content" style="background-image: url('<?php echo $song[3] ?>');"></a>
                                                            ...
                                                            <div class="item-info">
                                                                ...
                                                                <div class="item-title text-ellipsis">
                                                                    <a href="track.detail.html"><?php echo $song[1] ?></a>
                                                                </div>
                                            ...
                                            <div class="row m-b">
                                                ...
                                                <div class="col-xs-4 col-sm-4 col-md-3">
                                                    <div class="item r" data-id="" data-src="">
                                                        <div class="item-media ">
                                                            <a href="track.detail.html" class="item-media-content" style="background-image: url('');"></a>
                                                            <div class="item-overlay center">
                                                                <button  class="btn-playpause">Play</button>
                                                            </div>
                                                        </div>
...
<!--                                                                    <i class="fa fa-play text-muted"></i> 30 
                                        ...
                                        <div class="tab-pane" id="like">
                                            <div class="row m-b"> 
                                                <?php
                                                $sql4 = "SELECT a.TrackID, b.TrackName, b.Desc, b.ImageFile, b.TrackFile, b.ReleaseDate FROM tb_track_liked a INNER JOIN tb_track b on a.TrackID = b.TrackID WHERE a.UserID = '$userid'";
                                                $query4 = mysqli_query($link, $sql4);
                                                $queue4 = mysqli_fetch_all($query4);
                                                foreach ($queue4 as $song4) {
                                                    ?>
                                                    <div class="col-xs-4 col-sm-4 col-md-3">
                                                        <div class="item r" data-id="<?php echo $song4[0] ?>" data-src="<?php echo $song4[4] ?>">
                                                            <div class="item-media ">
                                                                <a href="track.detail.html" class="item-media-content" style="background-image: url('<?php echo $song4[3] ?>');"></a>
                                                                <div class="item-overlay center">
                                                                    <button  class="btn-playpause">Play</button>
                                                                </div>
                                                            </div>
                                                            <div class="item-info">
                                                                ...
                                                                <div class="item-title text-ellipsis">
                                                                    <a href="track.detail.html"><?php echo $song4[1] ?></a>
                                                                </div>
                                                                <div class="item-author text-sm text-ellipsis hide">
                                                                    <a href="artist.detail.html" class="text-muted">Postiljonen</a>
                                                                </div>
                                        ...
                                        <div class="tab-pane" id="profile">
                                            ...
                                            <form>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9"><input value="<?php echo $userid ?>" class="form-control"></div>
                                                </div>
                                                <div class="form-group row">
                            ...
                            <div class="col-lg-3 w-xxl w-auto-md">
                                <div class="padding" style="bottom: 60px;" data-ui-jp="stick_in_parent">
                                    ...
                                    <div class="row item-list item-list-sm m-b">
                                        <?php
                                        $sql5 = "SELECT a.TrackID, COUNT(a.TrackID), b.TrackName, b.ImageFile, b.TrackFile, d.artistName FROM tb_track_liked a INNER JOIN tb_track b ON a.TrackID = b.TrackID INNER JOIN tb_artist_track c ON b.TrackID = c.TrackID LEFT JOIN tb_artist d ON c.ArtistID = d.ArtistID  GROUP BY a.TrackID ORDER BY COUNT(a.TrackID) DESC, b.TrackName ASC LIMIT 5";
                                        $query5 = mysqli_query($link, $sql5);
                                        $kq = mysqli_fetch_all($query5);
                                        foreach ($kq as $like) {
                                            ?>
                                            <div class="col-xs-12">
                                                <div class="item r" data-id="<?php echo $like[0] ?>" data-src="<?php echo $like[4] ?>">
                                                    <div class="item-media ">
                                                        <a href="track.detail.html" class="item-media-content" style="background-image: url('<?php echo $like[3] ?>');"></a>
                                                    </div>
                                                    <div class="item-info">
                                                        <div class="item-title text-ellipsis">
                                                            <a href="track.detail.html"><?php echo $like[2] ?></a>
                                                        </div>
                                                        <div class="item-author text-sm text-ellipsis ">
                                                            <a href="artist.detail.html" class="text-muted"><?php echo$like[5] ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
