...
<!-- ############ PHP Signin STOP-->
        ...
        <form id="form_login" name="form_login" action="signin.php" method="POST">
          <div class="form-group">
            <input type="email" id="txtUserEmail" name="txtUserEmail" class="form-control" placeholder="Email" value ="Fpt1907@gmail.com" required>
          </div>
          <div class="form-group">
            <input type="password" id="txtUserPass" name="txtUserPass" class="form-control" placeholder="password" value="Fpt1907" required>
          </div>      
          <div class="m-b-md">        
