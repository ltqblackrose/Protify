...
<html lang="en">
    ...
    <body>
                                        ...
                                        <div class="">
                                            <div class="item r" data-id="item-<?php echo $number_discover + 7 ?>" data-src="<?php echo $discover[3] ?>">
                                                <div class="item-media ">
                                                    <a href="track.detail.php?TrackID=<?php echo $discover[0] ?>" class="item-media-content" style="background-image: url('<?php echo $discover[4] ?>');"></a>
                                                ...
                                                <div class="item-info">
                                                    <div class="item-overlay bottom text-right">
                                                        ...
                                                        <div class="dropdown-menu pull-right black lt">
                                                            <a class="dropdown-item" href="add_to_queue_savedata.php?trackid=<?php echo $discover[0] ?>"><i class="fa fa-plus fa-fw text-left"></i> Add to Queque</a>
                                                    ...
                                                    <div class="item-title text-ellipsis">
                                                        <a href="track.detail.php?TrackID=<?php echo $discover[0] ?>">All I Need</a>
                                                    </div>
                                                    <div class="item-author text-sm text-ellipsis ">
                                                        <a href="artist.detail.php?ArtistID=<?php echo $discover[5] ?>" class="text-muted">Pablo Nouvelle</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         items: 3
                                            ...
                                            <div class="">
                                                <div class="item r" data-id="item-<?php echo $number_treading + 7 ?>" data-src="<?php echo $treading[2] ?>">
                                                    <div class="item-media ">
                                                        <a href="track.detail.php?TrackID=<?php echo $treading[0] ?>" class="item-media-content" style="background-image: url('images/b8.jpg');"></a>
                                                        <div class="item-overlay center">
                                                            <button  class="btn-playpause">Play</button>
                                                        </div>
                                                    </div>
                                                    <div class="item-info">
                                                        <div class="item-overlay bottom text-right">
                                                            ...
                                                            <a href="#" class="btn-more" data-toggle="dropdown"><i class="fa fa-ellipsis-h"></i></a>
                                                            <div class="dropdown-menu pull-right black lt">
                                                                <a class="dropdown-item" href="add_to_queue_savedata.php?trackid=<?php echo $treading[0] ?>"><i class="fa fa-plus fa-fw text-left"></i> Add to Queque</a>
                                                                <div class="dropdown-item dropdown-submenu">
                                                                    <a tabindex="-1" href="#"><i class="fa fa-music fa-fw text-left"></i> Add to Playlist</a>
                                                                    <div class="dropdown-menu pull-left dark" role="menu">
                                                        ...
                                                        <div class="item-title text-ellipsis">
                                                            <a href="track.detail.php?TrackID=<?php echo $treading[0] ?>"><?php echo $treading[1] ?></a>
                                                        </div>
                                                        <div class="item-author text-sm text-ellipsis ">
                                        ...
                                        foreach ($a_new as $key_new => $new) {
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-3">
                                                <div class="item r" data-id="item-<?php echo $number_new + 7 ?>" data-src="<?php echo $new[2] ?>">
                                                    <div class="item-media ">
                                                        <a href="track.detail.php?TrackID=<?php echo $new[0] ?>" class="item-media-content" style="background-image: url('<?php echo $new[5] ?>');"></a>
                                                        <div class="item-overlay center">
                                                            <button  class="btn-playpause">Play</button>
                                                        </div>
                                                    </div>
                                                    <div class="item-info">
                                                        <div class="item-overlay bottom text-right">
                                                            ...
                                                            <a href="#" class="btn-more" data-toggle="dropdown"><i class="fa fa-ellipsis-h"></i></a>
                                                            <div class="dropdown-menu pull-right black lt">
                                                                <a class="dropdown-item" href="add_to_queue_savedata.php?trackid=<?php echo $new[0] ?>"><i class="fa fa-plus fa-fw text-left"></i> Add to Queque</a>
                                                                <div class="dropdown-item dropdown-submenu">
                                                                    <a tabindex="-1" href="#"><i class="fa fa-music fa-fw text-left"></i> Add to Playlist</a>
                                                                    <div class="dropdown-menu pull-left dark" role="menu">
                                                        ...
                                                        <div class="item-title text-ellipsis">
                                                            <a href="track.detail.php?TrackID=<?php echo $new[0] ?>"><?php echo $new[1] ?></a>
                                                        </div>
                                                        <div class="item-author text-sm text-ellipsis ">
                                        ...
                                        foreach ($a_foryou as $key_foryou => $foryou) {
                                            ...
                                            <div class="col-sm-6">
                                                <div class="item r" data-id="item-<?php echo $number_foryou + 7 ?>" data-src="<?php echo $foryou[2] ?>">
                                                    <div class="item-media ">
                                                        <a href="track.detail.php?TrackID=<?php echo $foryou[0] ?>" class="item-media-content" style="background-image: url('images/b9.jpg');"></a>
                                                        <div class="item-overlay center">
                                                            <button  class="btn-playpause">Play</button>
                                                        </div>
                                                    </div>
                                                    <div class="item-info">
                                                        <div class="item-overlay bottom text-right">
                                                            ...
                                                            <a href="#" class="btn-more" data-toggle="dropdown"><i class="fa fa-ellipsis-h"></i></a>
                                                            <div class="dropdown-menu pull-right black lt">
                                                                <a class="dropdown-item" href="add_to_queue_savedata.php?trackid=<?php echo $foryou[0] ?>"><i class="fa fa-plus fa-fw text-left"></i> Add to Queque</a>
                                                                <div class="dropdown-item dropdown-submenu">
                                                                    <a tabindex="-1" href="#"><i class="fa fa-music fa-fw text-left"></i> Add to Playlist</a>
                                                                    <div class="dropdown-menu pull-left dark" role="menu">
                                                        ...
                                                        <div class="item-title text-ellipsis">
                                                            <a href="track.detail.php?TrackID=<?php echo $foryou[0] ?>"><?php echo $foryou[1] ?></a>
                                                        </div>
                                                        <div class="item-author text-sm text-ellipsis ">
        ...
        <!-- endbuild -->
        <script src="scripts/rtl.js"></script>
    </body>
</html>
