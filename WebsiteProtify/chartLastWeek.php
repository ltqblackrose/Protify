                        ...
                        <div class="row-col">
                            <div class="col-lg-9 b-r no-border-md">
                                <div class="padding">
                                    ...
                                    <?php
                                    $sql =  "SELECT TrackName, sum(TotalListen), trackfile, ImageFile, TrackID, ArtistName, ArtistID, TotalLiked, ArtistID, AlbumID FROM vw_track_listen_date_info WHERE yearweek(date) = yearweek(CURRENT_DATE) - 1 group by TrackID ORDER BY SUM(TotalListen) DESC,TrackName ASC LIMIT 10";
